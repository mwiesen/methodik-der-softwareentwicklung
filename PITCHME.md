...
**Variablen** sind Platzhalter für einen Wert. Dieser Platz (Speicherbereich) wird bei der **Deklaration** für die Variable reserviert. Damit der Wert der Variable korrekt interpretiert werden kann, wird die Art der Variable angegeben (Datentyp). Die Syntax bei einer Variablendeklaration ist daher wie folgt:


_Art-der-Variable_  _Name-der-Variable_

+++

### Beispiele

Art: `Zahl` , `Index` , `Name` , `Zeichenkette` oder auch `int`, `double` etc.  (evtl. in Kommentar näher beschreiben)
...
Beispiel:   `maximum = 3`,  `i > 0 ?`  oder  `vorname == „Thomas“ ?`` 

---

## Qualität von Programmablaufplänen
...
![start-ende](assets/images/papdef-startende.png)

+++

<img src="assets/images/papdef-startende.png" alt="start-ende" >
...
<div style="border:1px solid #cccccc">
  <div style="border:1px solid #cccccc;">
<img src="assets/images/papdef-startende.png">  </div>
  <div style="border:1px solid #cccccc; min-height:50%">
    <ul>
      <li> Jeder Algorithmus hat einen Anfang und ein Ende </li>
      <li> Name nicht vergessen!                           </li>
    </ul>
  </div>
</div>
...
<div style="border:1px solid #cccccc; display:flex">
  <div style="border:1px solid #cccccc; flex:1">
<img src="assets/images/papdef-startende.png">  </div>
  <div style="border:1px solid #cccccc; flex:1">
    <ul>
      <li> Jeder Algorithmus hat einen Anfang und ein Ende </li>
...
<table>
  <tr>
    <td>
<img src="assets/images/papdef-startende.png">
    </td>
    <td>
      <ul>
        <li> Jeder Algorithmus hat einen Anfang und ein Ende </li>
...
<ul>
<li> ![start-ende](assets/images/papdef-startende.png) </li>
<li> Jeder Algorithmus hat einen Anfang und ein Ende </li>
<li> Name nicht vergessen!                           </li>
</ul>
